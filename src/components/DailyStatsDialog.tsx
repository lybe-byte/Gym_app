...
export default function DailyStatsDialog({ isOpen, onClose, metric, stepsData, runsData }: DailyStatsDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-bg-primary/80 backdrop-blur-sm animate-fade-in print:hidden">
      <div 
        className="bg-bg-secondary w-full max-w-md sm:rounded-2xl rounded-t-2xl p-6 border border-border-color shadow-[0_0_40px_rgba(0,0,0,0.5)] animate-slide-up"
      >
